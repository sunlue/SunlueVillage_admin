<template>
	<div>
		<Upload  v-if="!audio" :action="$upload.audio" 
		:show-upload-list="false" accept="audio/mpeg"
		...
		<Button type="info" size="small" @click="modal.show=true" v-if="audio">{{$t('review')}}</Button>
		<Modal v-model="modal.show" :footer-hide="true" class="review" v-if="audio">
